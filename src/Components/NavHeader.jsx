      ...
      <div class="wrap-header-mobile">
        <Navbar light>
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="stext-104 cl4 hov-cl1" navbar>
              <NavItem>
              ...
              {dataUser.user_role_id === 3 ? null : (
                <>
                  <NavItem>
                    <NavLink href="/verify-payment">Verify Payment</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/manage-products">Manage Products</NavLink>
                  </NavItem>
                </>
              )}
              {dataUser.username ? (
                <>
                  ...
                  <NavItem>
                    <NavLink href="/history-transaction">
                      History Transaction
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/user-profile">User Profile</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/change-password">Change Password</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/" onClick={logOutBtn}>
                      Logout
                    </NavLink>
                  </NavItem>
                </>
